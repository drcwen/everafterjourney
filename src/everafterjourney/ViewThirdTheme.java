 ...
 * @author Wendel
 */
public class ViewThirdTheme extends javax.swing.JFrame {

    /**
     * Creates new form ViewThirdTheme
     */
    public ViewThirdTheme() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(184, 156, 87));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/gold.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThirdTheme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewThirdTheme().setVisible(true);
            }
        });
    }
