 ...
 * @author Wendel
 */
public class ViewSecondTheme extends javax.swing.JFrame {

    /**
     * Creates new form ViewSecondTheme
     */
    public ViewSecondTheme() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(172, 132, 110));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSecondTheme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSecondTheme().setVisible(true);
            }
        });
    }
